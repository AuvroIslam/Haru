...
GENERIC_TECH: frozenset[str] = frozenset(
    {
        ...
        "paas",
        "iaas",
        # Interface and protocol specs. Saying an app is "built on ASGI" when it
        # uses FastAPI is accurate, not a claim about an unowned product —
        # blocking it is the cry-wolf failure that gets a validator switched off.
        "asgi",
        "wsgi",
        "websocket",
        "websockets",
